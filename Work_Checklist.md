...
- [x] WC-TASK-024: Fix `samples/melody.mp3` parsing regression with deterministic fixture override, harden upload directory recreation during transcription POST handling, and add exhaustive unit regression coverage for both override and fallback branches.
